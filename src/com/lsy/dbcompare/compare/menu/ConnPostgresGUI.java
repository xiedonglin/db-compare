 ...
 * </pre></h5>
 */
public class ConnPostgresGUI extends JFrame{
	private ConnPostgresGUI self = this;
	...
	private JPanel getBtnBox() {
		...
		testBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ConnInfo info = new ConnInfo(connName, "Postgres", sid, host, port, username, pwd, null);
